...
import { getUsernamesOnlyFollow, saveusersFollowingAndGenderchek, saveUsernameOnlyFollow, updateDailyCount, checkDailyLimit } from '../Utils/jsonUtils.js';
...
const usernamesNoFollow = new Set();
...
export async function* followGenerator(browser, page, action, genero_buscado) {
